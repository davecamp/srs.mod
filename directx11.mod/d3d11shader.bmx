...
UUIDFromStringW("{6E6FFA6A-9BAE-4613-A51E-91652D508C21}", IID_ID3D11ShaderReflectionType)
UUIDFromStringW("{51F23923-F3E5-4BD1-91CB-606177D8DB4C}", IID_ID3D11ShaderReflectionVariable)
UUIDFromStringW("{EB62D63D-93DD-4318-8AE8-C6F83AD371B8}", IID_ID3D11ShaderReflectionConstantBuffer)
UUIDFromStringW("{8d536ca1-0cca-4956-a837-786963755584}", IID_ID3D11ShaderReflection)
UUIDFromStringW("{54384F1B-5B3E-4BB7-AE01-60BA3097CBB6}", IID_ID3D11LibraryReflection)
UUIDFromStringW("{207BCECB-D683-4A06-A8A3-9B149B9F73A4}", IID_ID3D11FunctionReflection)
UUIDFromStringW("{42757488-334F-47FE-982E-1A65D08CC462}", IID_ID3D11FunctionParameterReflection)
UUIDFromStringW("{CAC701EE-80FC-4122-8242-10B39C8CEC34}", IID_ID3D11Module)
UUIDFromStringW("{469E07F7-045A-48D5-AA12-68A478CDF75D}", IID_ID3D11ModuleInstance)
UUIDFromStringW("{59A6CD0E-E10D-4C1F-88C0-63ABA1DAF30E}", IID_ID3D11Linker)
UUIDFromStringW("{D80DD70C-8D2F-4751-94A1-03C79B3556DB}", IID_ID3D11LinkingNode)
UUIDFromStringW("{54133220-1CE8-43D3-8236-9855C5CEECFF}", IID_ID3D11FunctionLinkingGraph)
